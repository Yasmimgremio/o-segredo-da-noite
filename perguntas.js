export const perguntas = [
    {
        enunciado: "Violetta, desconfiada dos desaparecimentos noturnos de Damon, decide segui-lo até uma clareira na floresta. Lá, ela o vê se transformando em um vampiro sob a luz da lua cheia. O choque a paralisa, mas Damon percebe sua presença, e ela se dá conta de que descobriu a verdade sobre ele. Qual a reação dela?",
        alternativas: [
            {
                texto: "Ficou assustada e com medo dele",
                afirmacao: [
                    "No início ficou com medo de que ele a machucasse.",
                    "Achou assustador pensar na possibilidade de ele seria o homem por quem ela se apaixonou."
                ],
                proxima: 1,
            },
            {
                texto: "Ficou surpresa, mas não sentiu medo.",
                afirmacao: [
                    "Quis saber como ele acabou naquela situação.",
    ...
    {
        enunciado: "No início ficou com medo de que ele a machucasse. Achou assustador pensar na possibilidade de que ele seria o homem por quem ela se apaixonou.",
        alternativas: [
            {
